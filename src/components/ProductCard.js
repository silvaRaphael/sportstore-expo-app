...
import { Text, View, TouchableOpacity, TouchableWithoutFeedback, Dimensions, Image, ScrollView, Animated } from 'react-native';

const { width } = Dimensions.get("window");

const ProductCard = ({
  item, name, image, color, colorName, onPress
}) => {
